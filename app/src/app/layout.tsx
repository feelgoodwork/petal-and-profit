    ...
    >
      <body className="min-h-full">
        <nav className="border-b bg-white px-6 py-3 flex items-center gap-6">
          ...
          <a href="/matching/recipes" className="text-sm text-stone-500 hover:text-stone-900">Review</a>
          ...
          <a href="/pilot-applications" className="text-sm text-stone-500 hover:text-stone-900">Pilot</a>
